...
@section('content')
<div class="row">
<form action="/updateportsection3" method="post" enctype="multipart/form-data">
@csrf
      ...
      <h2 class="sub_title">Page Content</h2>
        ...
        <div class="x_content">
               ...
               <label for="exampleFormControlFile1">Image</label>
                ...
                <a href="{{url('view_portsection3')}}" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Back</a>
