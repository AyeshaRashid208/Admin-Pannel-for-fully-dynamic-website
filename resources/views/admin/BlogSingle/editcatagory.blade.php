...
@section('content')
<div class="row">
<form action="{{url('updatecatagory')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="x_title">
      <h2 class="sub_title">Page Content</h2>
        ...
        <div class="x_content">
                ...
                <a href="{{url('view_catagory')}}" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Back</a>
